...
static int countercompleted;


map<int, int> throughputtime;
...
void PrintCompleted()
{
	...
	if (countercompleted % 10 == 0)
		throughputtime[countercompleted] = count;
...
void PrintWaitingTime()
{
	...
	char dum = '%';
	printf("\n-------------------------------------------------------------");
	printf("\nCPU Utilisation : %0.2f%c\n", ((float)cpuutil / counter) * 100, dum);
	
	for(map<int,int>::iterator itprev = throughputtime.begin(); itprev != throughputtime.end(); ++itprev) 
	{
  		cout << itprev->first << " " << itprev->second << endl;
	}
	cout << "---------------------------------------------" << endl;

	// int totalprev;
	// int itc = 1;
	// for(map<int,int>::iterator it = throughputtime.begin(); it != throughputtime.end(); ++it) 
	// {
	...
	// 	int itprevc = 1;
	// 	for (map<int,int>::iterator itprev = throughputtime.begin(); itprevc != itc; ++itprev, ++itprevc)
	// 	{
	// 		totalprev += (itprev->second);
	// 	}
	// 	it->second = (it->second - totalprev);
  	// 	cout << it->first << " " << it->second << endl;
	// }
}
